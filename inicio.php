...
<html lang="es">
	...
	<body>
		...
		<section class="inicio">
			<article>
				<h2>Web App Work Papers</h2>
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
					Sed dolor ipsa totam accusantium nulla ad dolorum? Voluptate natus
					saepe itaque maxime consequatur libero excepturi voluptas quisquam,
					odit, voluptatum tenetur incidunt!</p>
			</article>
		</section>
